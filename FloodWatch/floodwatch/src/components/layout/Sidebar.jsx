...
import ReportIncidentCard from '../sidebar/ReportIncidentCard';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto pt-2 pb-12 flex flex-col gap-2">
        ...
        {/* Pass closeSidebar so mobile users can click the map after enabling reporting mode. */}
        <ReportIncidentCard closeSidebar={closeSidebar} />
      </div>
    </aside>
  );
}